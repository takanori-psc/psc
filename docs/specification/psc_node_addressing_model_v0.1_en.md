...
- Document Name : PSC Node Addressing Model
- Version       : v0.1
...
PSC uses a hierarchical addressing structure
to identify communication endpoints inside the PSC Fabric.

The address is composed of four hierarchical fields
representing the physical and logical topology of the fabric.

Basic Address Format

`Fabric ID : Cluster ID : Node ID : Port ID`

Each field represents a different level
of the PSC Fabric topology.
...
This hierarchical structure enables scalable addressing
and efficient routing across multi-cluster PSC fabrics.
...
5. TMU prepares transfer management
6. Scheduler schedules the transfer
7. TEU executes the transfer
